...
public class TwitterCritic extends PApplet {
   ...
   public void draw() {
    ...
    class Button {
      ...
      Button(int x, int y, int w, int h, int c, String l) {
        this.x = x;
        this.y = y;
        this.w = w;
        this.h = h;
  ...
  class TweetButton extends Button {
    public TweetButton(double positivity, int popularity, String link) {
      ...
      int blue = (int)(map((float)Math.abs(positivity), (float)0, (float).25f, (float)255, (float)0));
  ...
  class ProfileButton extends Button {
    ...
    public ProfileButton(int x, int y, int w, int h, int c, String l) {
      super(x, y, w, h, c, l);
    }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "TwitterCritic" };
    if (passedArgs != null) {
