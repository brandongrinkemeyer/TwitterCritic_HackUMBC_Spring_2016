   ...
   public void setup() {
     ...
     profileImg = loadImage("https://pbs.twimg.com/profile_images/504287439511617536/SzagAEPy.jpeg");
   ...
   public void draw() {
    ...
    public void contextItems() {
     ...
     text("TwitterCritic", (int)width/2, 60);
     textFont(f, 22);
     text("positivity analysis of: " + profileURL, (int)width/2, 80);
     textFont(f, 18);
     textAlign(LEFT, BOTTOM);
     text("Newer Tweets", (int)PROFILE_IMAGE_SIZE/2, PROFILE_IMAGE_SIZE + 50);
     text("Older Tweets", (int)PROFILE_IMAGE_SIZE/2, height - PROFILE_IMAGE_SIZE);
     ...
     stroke(255);     
     line((int)PROFILE_IMAGE_SIZE/3, PROFILE_IMAGE_SIZE + 40, (int)PROFILE_IMAGE_SIZE/3, height - PROFILE_IMAGE_SIZE);
  ...
  class TweetButton extends Button {
    ...
    public TweetButton(double positivity, int popularity, String link) {
      super((int)(map((float)positivity, (float)-1, (float)1, (float)PROFILE_IMAGE_SIZE, (float)width - PROFILE_IMAGE_SIZE)),
            ...
            link);
      red = (int)(map((float)positivity, (float)-1, (float)0, (float)255, (float)100));
      green = (int)(map((float)positivity, (float)0, (float)1, (float)100, (float)255));
      blue = (int)(map((float)Math.abs(positivity), (float)0, (float).25, (float)255, (float)0));
